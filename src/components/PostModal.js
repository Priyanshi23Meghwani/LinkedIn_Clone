        ...
        <Content>
            <Header>
                ...
                <button onClick = {(event) => reset(event)}>
                    <img src="/images/down-icon.svg" alt="close-icon" />
                </button>
            </Header>
            <SharedContent>
                <UserInfo>
            ...
            <ShareCreation>
                <AttachAssets>
                    <AssetButton onClick={() => switchAssetArea("image")} >
                        <img src="/images/photo.svg" alt="share-image" />
                    </AssetButton>
                    <AssetButton onClick={() => switchAssetArea("media")}>
                        <img src="/images/video.svg" alt="share-video" />
                    </AssetButton>
                </AttachAssets>
                <ShareComment>
                    <AssetButton  > 
                            <img src="/images/comment-icon.svg" alt="share-comment" />
                    </AssetButton>
                </ShareComment>
